...
class Lecture(models.Model):
    ...
    category_d1 = models.CharField(
        max_length=2,
        choices=CategoryDepth1.choices)
    category_d2 = models.CharField(
        max_length=3,
        choices=CategoryDepth2.choices,
        null=True,
        default=None
    )
    category_d3 = models.CharField(
        max_length=3,
        choices=CategoryDepth3.choices,
        null=True,
        default=None
    )
    category_d4 = models.CharField(
        max_length=3,
        choices=CategoryDepth4.choices,
        null=True,
        default=None
    )
    created_at = models.DateTimeField(auto_now_add=True)
