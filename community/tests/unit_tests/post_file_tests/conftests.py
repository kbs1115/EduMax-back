...
def valid_file_instance_list(valid_post_instance_list):
    return [
        File(id=1, post=valid_post_instance_list[0], file_location="test_location1"),
        File(id=2, post=valid_post_instance_list[0], file_location="test_location2"),
    ]
...
def mocked_get_post_obj(mocker, valid_post_instance_list):
    mocker = mocker.patch(
        "community.service.post_service.get_post_instance",
